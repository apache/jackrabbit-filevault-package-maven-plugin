...
public class CompositeInterpolatorCustomizer implements Consumer<Interpolator> {
    ...
    public CompositeInterpolatorCustomizer(Collection<Consumer<Interpolator>> interpolatorCustomizers) {
        this.interpolatorCustomizers = interpolatorCustomizers;
    }

    @Override
    public void accept(Interpolator t) {
        interpolatorCustomizers.forEach(c -> c.accept(t));
    }
